...
if __name__ == "__main__":
    ...
    print("="*80)
    print("CosApp Truck OPEX Calculator - Test Scenarios")
    print("Following exact diagram specifications with color-coded inputs")
    print("="*80)
    
    # ========================================================================
    # SCENARIO 1: Heavy Diesel Truck in France (Long-haul transport)
    # ========================================================================
    print("\n" + "#"*80)
    print("### SCENARIO 1: Heavy Diesel Truck in France (N3, Long-haul) ###")
    print("#"*80)
    
    sys1 = TruckOPEXCalculator('opex_diesel_fr', db_path='data_opex_trucks.json')
    
    # User inputs (Orange arrows)
    sys1.purchase_cost = 150000.0
    sys1.type_energy = 'diesel'
    sys1.size_vehicle = 'N3'
    sys1.registration_country = 'France'
    sys1.annual_distance_travel = 120000.0  # High mileage
    sys1.departure_city = 'Paris'
    sys1.arrival_city = 'Marseille'
    sys1.RV = 45000.0
    sys1.N_years = 5.0
    sys1.team_count = 1
    sys1.maintenance_cost = 7000.0
    
    # Digital Twin Simulation outputs (Orange arrows from DTS)
    sys1.consumption_energy = 42000.0  # liters diesel per year
    sys1.fuel_multiplier = 1.0
    sys1.EF_CO2_diesel = 2.65  # kg CO2/liter diesel
    ...
    sys1.run_drivers()
    sys1.print_results()
    sys1.save_results_to_file("scenario1_diesel_france.txt")
    ...
    sys2 = TruckOPEXCalculator('opex_electric_de', db_path='data_opex_trucks.json')
    
    # User inputs (Orange arrows)
    sys2.purchase_cost = 95000.0
    sys2.type_energy = 'electric'
    sys2.size_vehicle = 'N2'
    sys2.registration_country = 'Germany'
    sys2.annual_distance_travel = 35000.0  # Lower urban mileage
    sys2.departure_city = 'Berlin'
    sys2.arrival_city = 'Hamburg'
    sys2.RV = 38000.0
    sys2.N_years = 5.0
    sys2.team_count = 1
    sys2.maintenance_cost = 3000.0  # Lower maintenance for electric
    
    # Digital Twin Simulation outputs (Orange arrows from DTS)
    sys2.consumption_energy = 21000.0  # kWh per year
    sys2.fuel_multiplier = 0.3  # Much cleaner
    sys2.EF_CO2_diesel = 0.0  # Zero direct emissions
    
    driver2 = sys2.add_driver(RunOnce('run2'))
    sys2.run_drivers()
    sys2.print_results()
    sys2.save_results_to_file("scenario2_electric_germany.txt")
    ...
    sys3 = TruckOPEXCalculator('opex_h2_es', db_path='data_opex_trucks.json')
    ...
    sys4 = TruckOPEXCalculator('opex_hybrid_it', db_path='data_opex_trucks.json')
